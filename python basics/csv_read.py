...
# Read csv in python
with open('data\BPI-Sep2020.csv') as csv_file:
...
#     employee_writer.writerow(['Jack A', 'Marketing', 'November'])
#     employee_writer.writerow(['Eric B', 'Software', 'March'])
...
#     writer.writeheader()
#     writer.writerow(
#         {'Name': 'Jack C', 'Department': 'Marketing', 'Month': 'November'})
#     writer.writerow(
#         {'Name': 'Eric Smith', 'Department': 'Software', 'Month': 'March'})
